...
public class AceQLApiHttpExample {
	...
	System.out.println("aceQlApi.getAutoCommit() : "
		+ aceQLHttpApi.getAutoCommit());
	System.out.println("aceQlApi.isReadOnly()    : "
		+ aceQLHttpApi.isReadOnly());
	System.out.println("aceQlApi.getHoldability(): "
		+ aceQLHttpApi.getHoldability());
	...
	if (doInsert) {
		...
		if (i % 100 == 0) System.out.println("Inserts: " + i);
		...
		builder.setParameter(j++, AceQLTypes.VARCHAR, "John_"
			+ customerId);
		builder.setParameter(j++, AceQLTypes.VARCHAR, "Smith_"
			+ customerId);
		builder.setParameter(j++, AceQLTypes.VARCHAR, customerId
			+ " César Avenue");
		builder.setParameter(j++, AceQLTypes.VARCHAR, "Town_"
			+ customerId);
		builder.setParameter(j++, AceQLTypes.VARCHAR, customerId + "");
		builder.setParameter(j++, AceQLTypes.VARCHAR, customerId
			+ "-12345678");
	...
	if (doBlobUpload) {
	    ...
	    PrepStatementParametersBuilder builder = new PrepStatementParametersBuilder();
	    int j = 1;
	    builder.setParameter(j++, AceQLTypes.INTEGER, new Integer(
		    customerId).toString());
	    builder.setParameter(j++, AceQLTypes.INTEGER,
		    new Integer(itemId).toString());
	    builder.setParameter(j++, AceQLTypes.VARCHAR, "description_"
		    + itemId);
	    builder.setParameter(j++, AceQLTypes.NUMERIC, new Integer(
		    itemId * 1000).toString());
	    ...
	    builder.setParameter(j++, AceQLTypes.NUMERIC,
