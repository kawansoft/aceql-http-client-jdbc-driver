...
public class AceQLConnectionExample {
	...
	Connection connection = new AceQLConnection(serverUrl, database,
		username, password);
	...
	System.out.println("aceQLConnection.getServerVersion(): "
		+ ((AceQLConnection) connection).getServerVersion());
	System.out.println("aceQLConnection.getClientVersion(): "
		+ ((AceQLConnection) connection).getClientVersion());

	System.out.println("aceQLConnection.getAutoCommit() : "
		+ connection.getAutoCommit());
	System.out.println("aceQLConnection.isReadOnly()    : "
		+ connection.isReadOnly());
	System.out.println("aceQLConnection.getHoldability(): "
...
//		}
    ...
    /*
     * private static void loopInsertIntoOrderlog(AceQLConnection
     * aceQLConnection) throws SQLException {
     * 
     ...
     * Integer(itemId).toString()); builder.setParameter(j++,
     * AceQLTypes.VARCHAR, "description_" + itemId); builder.setParameter(j++,
     * AceQLTypes.NUMERIC, new Integer(itemId * 1000).toString());
     * builder.setParameter(j++, AceQLTypes.DATE, new
     * Long(System.currentTimeMillis()).toString()); builder.setParameter(j++,
     * AceQLTypes.TIMESTAMP, new Long(System.currentTimeMillis()).toString());
     * builder.setParameter(j++, AceQLTypes.VARBINARY, null);
