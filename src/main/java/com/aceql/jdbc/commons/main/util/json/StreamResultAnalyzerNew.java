 ...
 *
 */
public class StreamResultAnalyzerNew {
     ...
     * Constructor.
     * 
     * @param inputStreamSaver
     * @param httpStatusCode
     * @param httpStatusMessage
     */
    public StreamResultAnalyzerNew(InputStreamSaver inputStreamSaver, int httpStatusCode, String httpStatusMessage) {
...
//	}
	...
	try {
	    try {
		InputStream in = inputStreamSaver.getInputStream();
...
//	}
	...
	try {
	    in = inputStreamSaver.getInputStream();
	    return FastRowCounter.getRowCount(in, inputStreamSaver.getLength());
	} catch (Exception e) {
	    this.parseException = e;
