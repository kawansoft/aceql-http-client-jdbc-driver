...
import com.aceql.jdbc.commons.main.util.json.RowParserNew;
 ...
 *
 */
public class AceQLResultSetNew extends AbstractResultSet implements ResultSet, Closeable {
    ...
    private RowParserNew rowParser;
    ...
    /** A File or String containing the result set returned by an /execute_query call */
    private InputStreamSaver inputStreamSaver;
     ...
     */
    public AceQLResultSetNew(InputStreamSaver inputStreamSaver, Statement statement, int rowCount) throws SQLException {

	if (inputStreamSaver == null) {
	    throw new SQLException("inputStreamSaver is null!");
	}

	this.inputStreamSaver = inputStreamSaver;
	...
	this.rowParser = new RowParserNew(inputStreamSaver);
     ...
     * @throws SQLException
     */
    public AceQLResultSetNew(InputStreamSaver inputStreamSaver, AceQLConnection aceQLConnection, int rowCount) throws SQLException {
	if (inputStreamSaver == null) {
	    throw new SQLException("inputStreamSaver is null!");
	}
	...
	*/
	...
	//HACK NDP values.add(this.jsonFile);
