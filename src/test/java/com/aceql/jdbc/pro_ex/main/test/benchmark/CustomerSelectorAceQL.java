 ...
 *
 */
public class CustomerSelectorAceQL {
	...
	TimeUtil.DEBUG = true;
	Connection connection = AceQLDriverLoader.getConnection("http://localhost:9090/aceql", "sampledb", "user1", "password1".toCharArray());
