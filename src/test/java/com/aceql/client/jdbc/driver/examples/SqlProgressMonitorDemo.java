...
PropertyChangeListener {
	...
	try {
	    ...
	    Connection connection = aceQLCommunityGetConnection(url, database,
    ...
    public static Connection aceQLCommunityGetConnection(String url, String database, String user, String password)
    ...
    public static Connection aceQLProGetConnection(String url, String database, String user, String password)
	    throws ClassNotFoundException, NoSuchMethodException, SecurityException, InstantiationException,
	    IllegalAccessException, IllegalArgumentException, InvocationTargetException, SQLException {

	String driverClassName = "com.aceql.client.jdbc.driver.pro.AceQLDriverPro";
	@SuppressWarnings("unused")
	Class<?> c = Class.forName(driverClassName);
	...
	frame.pack();
        ...
        Point middlePoint = new Point((dim.width / 2) - (frame.getWidth() / 2),
                (dim.height / 2) - (frame.getHeight() / 2));
        frame.setLocation(middlePoint);
